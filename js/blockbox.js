;(function ( $, window, document, undefined ) {
    ...
    $.extend(Plugin.prototype, {
        ...
        drawContainer: function() {
            ...
            var ul_contentBlock = $("<ul>").addClass("contentBlock").attr("style", "width: 624px; background-color: "+this.settings.background_color).appendTo(div_gridster);
            ...
            if (e.settings.mail == true) {
                ...
                var iframe_mail = $("<iframe>").attr("src", globalUrlPrefix+"/email?id="+e.settings.blockbox).attr("id", "mailIFrame").attr("frameborder", "0").attr("width", "624px").attr("height", "1000").appendTo(sectiontab_mail);
            }
        ...
        addBlock: function (block, datablock, blockbox, cloneid) {
            ...
            var container = $("<div style=\"background-color:"+this.settings.background_color+"\">").addClass("container").attr("id", "editor" + newid).html("<div class=\"loaderOverlay\"><div class=\"loader\"><div class=\"loader-inner ball-pulse\"><div></div><div></div><div></div></div></div></div>").appendTo(wrapper)
